...
Reviewed current posts in `src/content/blog` and dynamic blog routes (`/blog/[...slug]`, `/blog/[...page]`, `/blog/[category]`, `/guides/[...slug]`, RSS route) to avoid duplicate intent.

Already covered themes include:
- Beginner gym intro and getting started
- General climbing shoe selection and beginner shoe guides
- General gear guide
- Membership costs/value
- Indoor wall overview and building a wall (broad)
- Workout/fitness benefits

## Selected Week 3 Topics

| Primary Keyword | Intent | Volume | KD | CPC (USD) | Planned Slug | Why this is a good opportunity |
|---|---:|---:|---:|---:|---|---|
...
## Publishing Notes
- All five articles include:
  - internal links to existing relevant pages
  - authoritative external links
  - at least one `AffiliateBlock`
  - FAQ section
  - SEO-safe descriptions (<=160 chars)

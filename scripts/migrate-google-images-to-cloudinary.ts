...
const SUPABASE_SERVICE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlmZHhnZG5weWV4dW15cGN1c2llIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2MTYzMjA2OSwiZXhwIjoyMDc3MjA4MDY5fQ.OsC1ebMvN3u9THC_rByb_dF245RKtlQccRmHfXB-z7g';

// Cloudinary
cloudinary.config({
  cloud_name: 'dmjbktrra',
  api_key: '545148885653164',
  api_secret: 'AmsREsY_QDFjwMYX5my46nQCzoI',
  secure: true,
});

/**
 * Gym Data API - Direct Supabase Queries with Build-Time Caching
 * Fetches gym data directly from Supabase database
 * Uses in-memory cache during build to reduce egress
 */
 ...
 * to reduce Supabase calls from ~110 per build to 1 per build (~99% reduction)
 *
